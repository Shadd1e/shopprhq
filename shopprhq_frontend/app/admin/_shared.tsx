...
// NOTE: this file intentionally has NO page.tsx / route filename.
// Next.js's App Router only allows a default export (plus a handful of
// reserved names like metadata) from a file named page.tsx — any other
// named export from a page file fails the production build with:
//   "X is not a valid Page export field"
// Everything reused by both /admin and /admin/accounts lives here instead.
...
export const BASE = `${process.env.NEXT_PUBLIC_API_URL ?? 'https://ap.shopprhq.com'}/admin/whatsapp-setup`
